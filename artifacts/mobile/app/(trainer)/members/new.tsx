        ...
        <View style={styles.payRow}>
          {(['cash', 'upi', 'card', 'other'] as PayMethod[]).map(m => (
            <TouchableOpacity
              ...
              style={[styles.payBtn, { backgroundColor: form.paymentMethod === m ? colors.primary : colors.card, borderColor: form.paymentMethod === m ? colors.primary : colors.border, borderRadius: colors.radius }]}
            >
